...
-- Drop existing deny policies if they exist and recreate them
DROP POLICY IF EXISTS "usuarios_deny_anonymous_select" ON public."Usuarios";
DROP POLICY IF EXISTS "usuarios_deny_anonymous_insert" ON public."Usuarios";
DROP POLICY IF EXISTS "usuarios_deny_anonymous_update" ON public."Usuarios";
DROP POLICY IF EXISTS "usuarios_deny_anonymous_delete" ON public."Usuarios";
...
DROP POLICY IF EXISTS "usuarios_deny_all_delete" ON public."Usuarios";
