...
-- Migrar datos existentes de Usuarios a profiles si existen
INSERT INTO public.profiles (id, full_name, role, created_at)
SELECT id, nombre, rol, now()
...
-- =============== ACTUALIZAR CHAT ===============
-- Eliminar tablas anteriores de chat
...
-- Actualizar tipo de estado si es posible
-- ALTER TABLE public."Incidencias" 
-- ADD COLUMN IF NOT EXISTS new_status incident_status DEFAULT 'pendiente';
