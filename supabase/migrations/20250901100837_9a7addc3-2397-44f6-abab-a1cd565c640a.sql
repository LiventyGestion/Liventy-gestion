-- Create test users and demo properties with proper UUIDs
...
INSERT INTO public."Contratos" (id, propiedad_id, fecha_inicio, fecha_fin, estado, pdf_url) VALUES 
  ('c1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2024-01-01', '2024-12-31', 'activo', NULL),
  ('c2222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '2024-03-01', '2025-02-28', 'activo', NULL)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public."Pagos" (id, contrato_id, fecha_pago, importe, estado) VALUES 
  ('p1111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', '2024-01-01', 1200.00, 'pagado'),
  ('p2222222-2222-2222-2222-222222222222', 'c1111111-1111-1111-1111-111111111111', '2024-02-01', 1200.00, 'pagado'),
  ('p3333333-3333-3333-3333-333333333333', 'c1111111-1111-1111-1111-111111111111', '2024-03-01', 1200.00, 'pendiente'),
  ('p4444444-4444-4444-4444-444444444444', 'c2222222-2222-2222-2222-222222222222', '2024-03-01', 2500.00, 'pagado'),
  ('p5555555-5555-5555-5555-555555555555', 'c2222222-2222-2222-2222-222222222222', '2024-04-01', 2500.00, 'pagado')
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public."Incidencias" (id, propiedad_id, descripcion, estado, fecha_creacion, fecha_resolucion) VALUES 
  ('i1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Goteo en el grifo de la cocina', 'resuelto', '2024-02-15 10:30:00', '2024-02-16 14:20:00'),
  ('i2222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Problema con la calefacción', 'en_proceso', '2024-03-10 09:15:00', NULL),
  ('i3333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Revisión anual de instalaciones', 'pendiente', '2024-03-20 16:45:00', NULL)
ON CONFLICT (id) DO UPDATE SET
  descripcion = EXCLUDED.descripcion,
  estado = EXCLUDED.estado,
...
INSERT INTO public."Documentos" (id, propiedad_id, nombre_archivo, tipo, url, fecha_subida) VALUES 
  ('d1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'cedula_habitabilidad.pdf', 'cedula_habitabilidad', '/docs/cedula_apartamento_centro.pdf', '2024-01-01 12:00:00'),
  ('d2222222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'seguro_hogar.pdf', 'seguro', '/docs/seguro_apartamento_centro.pdf', '2024-01-01 12:15:00'),
  ('d3333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'escritura_propiedad.pdf', 'escritura', '/docs/escritura_atico_salamanca.pdf', '2024-03-01 10:30:00'),
  ('d4444444-4444-4444-4444-444444444444', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'ibi_2024.pdf', 'ibi', '/docs/ibi_atico_salamanca_2024.pdf', '2024-03-01 10:45:00')
ON CONFLICT (id) DO UPDATE SET
