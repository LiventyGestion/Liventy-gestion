-- Phase 1: Database Schema Hardening and Complete RLS Implementation
...
ALTER TABLE "Contratos" ADD CONSTRAINT fk_contratos_propiedad 
  FOREIGN KEY (propiedad_id) REFERENCES "Propiedades"(id) ON DELETE CASCADE;

ALTER TABLE "Pagos" ADD CONSTRAINT fk_pagos_contrato 
  FOREIGN KEY (contrato_id) REFERENCES "Contratos"(id) ON DELETE CASCADE;

ALTER TABLE "Documentos" ADD CONSTRAINT fk_documentos_propiedad 
  FOREIGN KEY (propiedad_id) REFERENCES "Propiedades"(id) ON DELETE CASCADE;

ALTER TABLE "Incidencias" ADD CONSTRAINT fk_incidencias_propiedad 
  FOREIGN KEY (propiedad_id) REFERENCES "Propiedades"(id) ON DELETE CASCADE;
