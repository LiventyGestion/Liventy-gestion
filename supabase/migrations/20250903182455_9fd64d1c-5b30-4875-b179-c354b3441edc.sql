...
-- Ensure lead viewing is restricted to authorized staff only
...
-- Replace with authenticated-only policy for anonymous calculations
...
USING (
  ...
  OR
  -- Propietarios can see calculations they created or own
...
-- 4. Ensure calculator results can only be inserted by authenticated users for anonymous calculations
