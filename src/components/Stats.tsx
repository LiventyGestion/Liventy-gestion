        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
              {/* Left Card - Neumorphic Style */}
              <div 
                className="rounded-[30px] p-8 transition-all duration-200 hover:translate-y-[-2px] cursor-pointer"
                style={{
                  background: '#e0e0e0',
              ...
              >
                <div className="text-center mb-8">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-4" style={{
                    ...
                    <Frown className="h-10 w-10 text-[#666666]" />
                  </div>
              ...
              {/* Right Card - Animated Border */}
              <div 
                className="rounded-[30px] p-1 transition-all duration-200 hover:scale-[1.02] cursor-pointer relative animate-border-glow"
                style={{
              ...
              >
                <div 
                  className="rounded-[26px] p-7 h-full"
                  style={{
                    background: '#ffffff',
                ...
                >
                  <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-20 h-20 bg-[#E67E0F]/10 rounded-full mb-4 shadow-lg">
                      <Smile className="h-10 w-10 text-[#E67E0F]" />
                    </div>
